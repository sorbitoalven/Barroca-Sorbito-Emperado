...
if(isset($_POST['update_profile'])){
    ...
    if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
        if($update_pass != $old_pass){
            ...
            mysqli_query($conn, "UPDATE `user_form` SET password = '$confirm_pass' WHERE id = 
    ...
    if(!empty($update_image)){
        if($update_image_size > 2000000 ){
            ...
            $image_update_query = mysqli_query($conn, "UPDATE `user_form` SET image =
...
<body>
    ...
    <?php
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <?php
                    if($fetch['image'] == ''){
                        echo '<img src="images/defualt-avatar.png">';
                    }else{
                ...
                <div class="flex">
                    <div class="inputBox">
                        ...
                        <input type="file" name="update_image" accepts="image/jpg, image/jpeg, image/png" class="box">
                    </div>
                    <div class="inputBox">
